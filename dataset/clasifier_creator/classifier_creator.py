...
try:
    from clasifier_creator.pipeline import ClassifierPipeline
    from clasifier_creator.utils import DataUtils, set_global_seed
except ModuleNotFoundError:
    # Running as a plain script: add the parent of this package to sys.path
    # so that `clasifier_creator` becomes importable as a package.
